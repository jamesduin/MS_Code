...
class FineRound(LearnRound):
    ...
    def createTrainWtYtrain(self,y_train):
        ...
        self.Fine_wt = np.array([0.3333333333333333, 0.16666666666666666, 0.3, 0.25, 1.3333333333333333, 0.3, 0.6666666666666666, 0.3333333333333333]) * train_wt
        return y_trainBin
