...
%\begin{table}[H]
%\centering
%\caption{BanditCostAnalysis}
%\label{tab:BanditCostAnalysis}
%\begin{tabular}{|l||l||l||l||l||l||l||l||l|}\toprule
%BANDIT & 0.000 & 0.003 & 0.001 & 0.001 & 0 & 8 & 4.800 & 2.315 \\
...
%FFR[0.7] & 0.000 & 0.012 & 0.002 & 0.004 & 0 & 8 & 3.300 & 2.571 \\
