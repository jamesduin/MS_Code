...
class LearnRound:
    ...
    def createTrainSet(self):
        ...
        self.y_train, self.X_train = data[:, 0], data[:, 1:data.shape[1]]
    ...
    def createTestSet(self):
        ...
        y_test, self.X_test = data_test[:, 0], data_test[:, 1:data_test.shape[1]]
    ...
    def createTrainWtYtrain(self):
        ...
        self.Fine_wt = np.array(
            [0.8695652173913044, 0.4347826086956522, 0.782608695652174, 0.6521739130434783, 3.4782608695652177,
             0.782608695652174, 1.7391304347826089, 0.8695652173913044]) * self.train_wt
    def trainClassifier(self):
