...
class FineRound(LearnRound):
    ...
    def createTrainWtYtrain(self,y_train):
        ...
        self.Fine_wt = np.array(
            [0.6956521739130435, 0.34782608695652173, 0.6260869565217392, 0.5217391304347826, 2.782608695652174,
             0.6260869565217392, 1.391304347826087, 0.6956521739130435]) * train_wt
        return y_trainBin
