    ...
    for type in rndTypes:
        ...
        for type in rndTypeFoldMat:
            ...
            #for fold in [1,2]:
                ...
                # if(fold == 1):
                #     x_axis = x_map
                #     prs = mapToAxis(x_map,resultMat)
                # else:
                #     prFold = mapToAxis(x_map,resultMat)
            ...
            plt.savefig('Inter_Map_RndNum_' + str(rndNum) + '_' + clftype + '_RocCurves_' + lvl + '.png')
        ...
        #     plt.savefig('Inter_Map_RndNum_' + str(rndNum) + '_' + clftype + '_PrCurves_' + lvl + '.png')