...
for type in rndType:
    for fld in fold:
        ...
        "#SBATCH --error=/home/scott/jamesd/"+runDir+"/log/job.%J.FFR_"  + type[0]+"p"+type[2] + "_" + str(fld) + ".err\n"
        "#SBATCH --output=/home/scott/jamesd/"+runDir+"/log/job.%J.FFR_"  + type[0]+"p"+type[2] + "_" + str(fld) + ".out\n")
        ...
        "python /home/scott/jamesd/"+runDir+"/runActPassParam.py " + type + " " + str(fld) + "\n"
